...
echo.
echo ============================================================
echo   Xerox VIPP Source Code Annotator
echo ============================================================
echo.
echo Beautifies VIPP source files AND adds a natural-language
echo comment after every instruction so non-Xerox experts can
echo read and understand the code.
echo.
...
py -3 "%~dp0xerox_annotator.py" "!SOURCE!" --output "!OUTPATH!"
